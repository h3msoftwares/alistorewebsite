/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1eeb1da18259ac5997ad0493b7795410)
// Runtime types generated with workerd@1.20260923.1 2026-09-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	API_SERVER_URL: "https://alistorewebsite-production.up.railway.app";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_SERVER_URL" | "NEXTJS_ENV">> {}
}
